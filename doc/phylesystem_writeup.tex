...
\begin{enumerate}
    ...
    \item \label{putStep} To save, the curator application uses and http PUT verb and includes the data (in \nexson) and the SHA.
...
The \otol project uses a set of these meta annotations to intoduce information from curators into the study records.
