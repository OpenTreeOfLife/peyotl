...
\begin{enumerate}
    \item merging many taxonomies into a comprehensive taxonomy of life,
...
\begin{enumerate}
   \setcounter{enumi}{2}
    ...
    \item a collection of curated phylogenetic statements,
...
\begin{enumerate}
   \setcounter{enumi}{5}
    \item browsing and annotating the supertree estimate of the tree of life,
...
The NexSON formats\citep{NexSON}, a set of serializations of NeXML \citep{NeXML} into JSON, are used
...
This component of the architecture \citep[described in more detail in][]{phylesystemapi}
    implements create, delete, update operations for a collection of trees in NexSON
